...
#'  at 2018-08-28 13:36:11
#' filename: ~/Desktop/delete_me//googlesheetsv4.auto/R/sheets_objects.R
#' api_json: api_json
#' 
...
CellFormat <- function(backgroundColor = NULL, padding = NULL, verticalAlignment = NULL, 
    borders = NULL, textDirection = NULL, wrapStrategy = NULL, textRotation = NULL, 
    numberFormat = NULL, hyperlinkDisplayType = NULL, horizontalAlignment = NULL, 
    textFormat = NULL) {
    structure(list(backgroundColor = backgroundColor, padding = padding, verticalAlignment = verticalAlignment, 
        ...
        textRotation = textRotation, numberFormat = numberFormat, hyperlinkDisplayType = hyperlinkDisplayType, 
...
#' @export
PivotGroup <- function(sortOrder = NULL, valueBucket = NULL, showTotals = NULL, valueMetadata = NULL, 
    groupRule = NULL, label = NULL, repeatHeadings = NULL, sourceColumnOffset = NULL) {
    structure(list(sortOrder = sortOrder, valueBucket = valueBucket, showTotals = showTotals, 
        valueMetadata = valueMetadata, groupRule = groupRule, label = label, repeatHeadings = repeatHeadings, 
        sourceColumnOffset = sourceColumnOffset), class = "gar_PivotGroup")
}
...
#' @export
ManualRuleGroup <- function(items = NULL, groupName = NULL) {
    structure(list(items = items, groupName = groupName), class = "gar_ManualRuleGroup")
}
...
PivotTable <- function(PivotTable.criteria = NULL, rows = NULL, valueLayout = NULL, 
    values = NULL, source = NULL, columns = NULL, criteria = NULL) {
    structure(list(PivotTable.criteria = PivotTable.criteria, rows = rows, valueLayout = valueLayout, 
        values = values, source = source, columns = columns, criteria = criteria), 
...
Response <- function(addFilterView = NULL, addBanding = NULL, addProtectedRange = NULL, 
    duplicateSheet = NULL, updateEmbeddedObjectPosition = NULL, deleteConditionalFormatRule = NULL, 
    deleteDimensionGroup = NULL, duplicateFilterView = NULL, addDimensionGroup = NULL, 
    addChart = NULL, updateDeveloperMetadata = NULL, findReplace = NULL, addSheet = NULL, 
    updateConditionalFormatRule = NULL, createDeveloperMetadata = NULL, addNamedRange = NULL, 
    deleteDeveloperMetadata = NULL) {
    structure(list(addFilterView = addFilterView, addBanding = addBanding, addProtectedRange = addProtectedRange, 
        duplicateSheet = duplicateSheet, updateEmbeddedObjectPosition = updateEmbeddedObjectPosition, 
        deleteConditionalFormatRule = deleteConditionalFormatRule, deleteDimensionGroup = deleteDimensionGroup, 
        duplicateFilterView = duplicateFilterView, addDimensionGroup = addDimensionGroup, 
        addChart = addChart, updateDeveloperMetadata = updateDeveloperMetadata, findReplace = findReplace, 
        addSheet = addSheet, updateConditionalFormatRule = updateConditionalFormatRule, 
        createDeveloperMetadata = createDeveloperMetadata, addNamedRange = addNamedRange, 
        deleteDeveloperMetadata = deleteDeveloperMetadata), class = "gar_Response")
}
...
#' @export
TextFormatRun <- function(format = NULL, startIndex = NULL) {
    structure(list(format = format, startIndex = startIndex), class = "gar_TextFormatRun")
}
...
#' @export
GridData <- function(startColumn = NULL, rowMetadata = NULL, rowData = NULL, startRow = NULL, 
    columnMetadata = NULL) {
    structure(list(startColumn = startColumn, rowMetadata = rowMetadata, rowData = rowData, 
        startRow = startRow, columnMetadata = columnMetadata), class = "gar_GridData")
}
...
#' @export
FindReplaceRequest <- function(range = NULL, sheetId = NULL, matchCase = NULL, allSheets = NULL, 
    includeFormulas = NULL, matchEntireCell = NULL, find = NULL, searchByRegex = NULL, 
    replacement = NULL) {
    structure(list(range = range, sheetId = sheetId, matchCase = matchCase, allSheets = allSheets, 
        includeFormulas = includeFormulas, matchEntireCell = matchEntireCell, find = find, 
        searchByRegex = searchByRegex, replacement = replacement), class = "gar_FindReplaceRequest")
}
...
#' @export
GridProperties <- function(frozenRowCount = NULL, columnCount = NULL, frozenColumnCount = NULL, 
    columnGroupControlAfter = NULL, rowGroupControlAfter = NULL, rowCount = NULL, 
    hideGridlines = NULL) {
    structure(list(frozenRowCount = frozenRowCount, columnCount = columnCount, frozenColumnCount = frozenColumnCount, 
        columnGroupControlAfter = columnGroupControlAfter, rowGroupControlAfter = rowGroupControlAfter, 
        rowCount = rowCount, hideGridlines = hideGridlines), class = "gar_GridProperties")
}
...
#' @export
Sheet <- function(rowGroups = NULL, data = NULL, properties = NULL, columnGroups = NULL, 
    conditionalFormats = NULL, protectedRanges = NULL, developerMetadata = NULL, 
    basicFilter = NULL, merges = NULL, bandedRanges = NULL, charts = NULL, filterViews = NULL) {
    structure(list(rowGroups = rowGroups, data = data, properties = properties, columnGroups = columnGroups, 
        conditionalFormats = conditionalFormats, protectedRanges = protectedRanges, 
        developerMetadata = developerMetadata, basicFilter = basicFilter, merges = merges, 
...
#' @export
PivotGroupValueMetadata <- function(collapsed = NULL, value = NULL) {
    structure(list(collapsed = collapsed, value = value), class = "gar_PivotGroupValueMetadata")
}
...
WaterfallChartSpec <- function(series = NULL, connectorLineStyle = NULL, domain = NULL, 
    firstValueIsTotal = NULL, hideConnectorLines = NULL, stackedType = NULL) {
    structure(list(series = series, connectorLineStyle = connectorLineStyle, domain = domain, 
        firstValueIsTotal = firstValueIsTotal, hideConnectorLines = hideConnectorLines, 
        stackedType = stackedType), class = "gar_WaterfallChartSpec")
}
...
#' @export
UpdateConditionalFormatRuleRequest <- function(index = NULL, sheetId = NULL, newIndex = NULL, 
    rule = NULL) {
    structure(list(index = index, sheetId = sheetId, newIndex = newIndex, rule = rule), 
...
#' @export
PasteDataRequest <- function(data = NULL, delimiter = NULL, type = NULL, html = NULL, 
    coordinate = NULL) {
    structure(list(data = data, delimiter = delimiter, type = type, html = html, 
        coordinate = coordinate), class = "gar_PasteDataRequest")
}
...
#' @export
AppendDimensionRequest <- function(length = NULL, sheetId = NULL, dimension = NULL) {
    structure(list(length = length, sheetId = sheetId, dimension = dimension), class = "gar_AppendDimensionRequest")
}
...
#' @export
TextRotation <- function(angle = NULL, vertical = NULL) {
    structure(list(angle = angle, vertical = vertical), class = "gar_TextRotation")
}
...
#' @export
PieChartSpec <- function(domain = NULL, threeDimensional = NULL, series = NULL, legendPosition = NULL, 
    pieHole = NULL) {
    structure(list(domain = domain, threeDimensional = threeDimensional, series = series, 
        legendPosition = legendPosition, pieHole = pieHole), class = "gar_PieChartSpec")
}
...
#' @export
UpdateDeveloperMetadataRequest <- function(fields = NULL, developerMetadata = NULL, 
    dataFilters = NULL) {
    structure(list(fields = fields, developerMetadata = developerMetadata, dataFilters = dataFilters), 
...
#' @export
Request <- function(updateSpreadsheetProperties = NULL, deleteEmbeddedObject = NULL, 
    ...
    autoFill = NULL, deleteDimension = NULL, sortRange = NULL, deleteProtectedRange = NULL, 
    deleteDimensionGroup = NULL, duplicateFilterView = NULL, addChart = NULL, findReplace = NULL, 
    updateChartSpec = NULL, textToColumns = NULL, updateProtectedRange = NULL, addSheet = NULL, 
    deleteFilterView = NULL, copyPaste = NULL, insertDimension = NULL, deleteRange = NULL, 
    deleteBanding = NULL, addFilterView = NULL, updateBorders = NULL, setDataValidation = NULL, 
    deleteConditionalFormatRule = NULL, clearBasicFilter = NULL, repeatCell = NULL, 
    appendDimension = NULL, createDeveloperMetadata = NULL, updateConditionalFormatRule = NULL, 
    insertRange = NULL, deleteDeveloperMetadata = NULL, moveDimension = NULL, randomizeRange = NULL, 
    updateBanding = NULL, deleteNamedRange = NULL, addProtectedRange = NULL, duplicateSheet = NULL, 
    unmergeCells = NULL, deleteSheet = NULL, updateEmbeddedObjectPosition = NULL, 
    addDimensionGroup = NULL, updateDimensionProperties = NULL, updateDeveloperMetadata = NULL, 
    pasteData = NULL, updateDimensionGroup = NULL, setBasicFilter = NULL, addConditionalFormatRule = NULL, 
    addNamedRange = NULL, updateCells = NULL) {
    structure(list(updateSpreadsheetProperties = updateSpreadsheetProperties, deleteEmbeddedObject = deleteEmbeddedObject, 
        updateFilterView = updateFilterView, addBanding = addBanding, appendCells = appendCells, 
        autoResizeDimensions = autoResizeDimensions, cutPaste = cutPaste, mergeCells = mergeCells, 
        updateNamedRange = updateNamedRange, updateSheetProperties = updateSheetProperties, 
        autoFill = autoFill, deleteDimension = deleteDimension, sortRange = sortRange, 
        deleteProtectedRange = deleteProtectedRange, deleteDimensionGroup = deleteDimensionGroup, 
        ...
        addFilterView = addFilterView, updateBorders = updateBorders, setDataValidation = setDataValidation, 
        ...
        addDimensionGroup = addDimensionGroup, updateDimensionProperties = updateDimensionProperties, 
        updateDeveloperMetadata = updateDeveloperMetadata, pasteData = pasteData, 
        updateDimensionGroup = updateDimensionGroup, setBasicFilter = setBasicFilter, 
        addConditionalFormatRule = addConditionalFormatRule, addNamedRange = addNamedRange, 
        updateCells = updateCells), class = "gar_Request")
}
...
#' @export
BasicChartSpec <- function(headerCount = NULL, stackedType = NULL, axis = NULL, threeDimensional = NULL, 
    chartType = NULL, interpolateNulls = NULL, series = NULL, legendPosition = NULL, 
    compareMode = NULL, domains = NULL, lineSmoothing = NULL) {
    structure(list(headerCount = headerCount, stackedType = stackedType, axis = axis, 
        threeDimensional = threeDimensional, chartType = chartType, interpolateNulls = interpolateNulls, 
        series = series, legendPosition = legendPosition, compareMode = compareMode, 
        domains = domains, lineSmoothing = lineSmoothing), class = "gar_BasicChartSpec")
}
...
#' @export
BubbleChartSpec <- function(series = NULL, legendPosition = NULL, bubbleOpacity = NULL, 
    bubbleSizes = NULL, domain = NULL, bubbleTextStyle = NULL, bubbleBorderColor = NULL, 
    groupIds = NULL, bubbleLabels = NULL, bubbleMinRadiusSize = NULL, bubbleMaxRadiusSize = NULL) {
    structure(list(series = series, legendPosition = legendPosition, bubbleOpacity = bubbleOpacity, 
        bubbleSizes = bubbleSizes, domain = domain, bubbleTextStyle = bubbleTextStyle, 
        bubbleBorderColor = bubbleBorderColor, groupIds = groupIds, bubbleLabels = bubbleLabels, 
        bubbleMinRadiusSize = bubbleMinRadiusSize, bubbleMaxRadiusSize = bubbleMaxRadiusSize), 
        class = "gar_BubbleChartSpec")
}
...
#' @export
CellData <- function(pivotTable = NULL, userEnteredFormat = NULL, note = NULL, effectiveFormat = NULL, 
    dataValidation = NULL, userEnteredValue = NULL, effectiveValue = NULL, formattedValue = NULL, 
    textFormatRuns = NULL, hyperlink = NULL) {
    structure(list(pivotTable = pivotTable, userEnteredFormat = userEnteredFormat, 
        note = note, effectiveFormat = effectiveFormat, dataValidation = dataValidation, 
        userEnteredValue = userEnteredValue, effectiveValue = effectiveValue, formattedValue = formattedValue, 
        textFormatRuns = textFormatRuns, hyperlink = hyperlink), class = "gar_CellData")
}
...
#' @export
BatchUpdateValuesByDataFilterRequest <- function(responseValueRenderOption = NULL, 
    includeValuesInResponse = NULL, valueInputOption = NULL, data = NULL, responseDateTimeRenderOption = NULL) {
...
#' @export
Padding <- function(top = NULL, left = NULL, right = NULL, bottom = NULL) {
    structure(list(top = top, left = left, right = right, bottom = bottom), class = "gar_Padding")
}
...
#' @export
UpdateDimensionGroupRequest <- function(fields = NULL, dimensionGroup = NULL) {
    structure(list(fields = fields, dimensionGroup = dimensionGroup), class = "gar_UpdateDimensionGroupRequest")
}
...
#' @export
SortRangeRequest <- function(sortSpecs = NULL, range = NULL) {
    structure(list(sortSpecs = sortSpecs, range = range), class = "gar_SortRangeRequest")
}
...
#' @export
MergeCellsRequest <- function(range = NULL, mergeType = NULL) {
    structure(list(range = range, mergeType = mergeType), class = "gar_MergeCellsRequest")
}
...
#' @export
DeveloperMetadata <- function(metadataKey = NULL, metadataId = NULL, location = NULL, 
    visibility = NULL, metadataValue = NULL) {
    structure(list(metadataKey = metadataKey, metadataId = metadataId, location = location, 
        visibility = visibility, metadataValue = metadataValue), class = "gar_DeveloperMetadata")
}
...
#' @export
ChartSpec <- function(title = NULL, altText = NULL, titleTextPosition = NULL, histogramChart = NULL, 
    ...
    subtitle = NULL, subtitleTextPosition = NULL, backgroundColor = NULL, basicChart = NULL, 
    orgChart = NULL, pieChart = NULL, titleTextFormat = NULL) {
    structure(list(title = title, altText = altText, titleTextPosition = titleTextPosition, 
        histogramChart = histogramChart, candlestickChart = candlestickChart, bubbleChart = bubbleChart, 
        waterfallChart = waterfallChart, fontName = fontName, maximized = maximized, 
        treemapChart = treemapChart, hiddenDimensionStrategy = hiddenDimensionStrategy, 
        subtitleTextFormat = subtitleTextFormat, subtitle = subtitle, subtitleTextPosition = subtitleTextPosition, 
        backgroundColor = backgroundColor, basicChart = basicChart, orgChart = orgChart, 
        pieChart = pieChart, titleTextFormat = titleTextFormat), class = "gar_ChartSpec")
}
...
#' @export
BatchGetValuesByDataFilterResponse <- function(valueRanges = NULL, spreadsheetId = NULL) {
    structure(list(valueRanges = valueRanges, spreadsheetId = spreadsheetId), class = "gar_BatchGetValuesByDataFilterResponse")
}
...
#' @export
LineStyle <- function(width = NULL, type = NULL) {
    structure(list(width = width, type = type), class = "gar_LineStyle")
}
...
#' @export
UpdateDimensionPropertiesRequest <- function(range = NULL, fields = NULL, properties = NULL) {
    structure(list(range = range, fields = fields, properties = properties), class = "gar_UpdateDimensionPropertiesRequest")
}
...
#' @export
SourceAndDestination <- function(source = NULL, dimension = NULL, fillLength = NULL) {
    structure(list(source = source, dimension = dimension, fillLength = fillLength), 
...
#' @export
HistogramChartSpec <- function(outlierPercentile = NULL, showItemDividers = NULL, 
    series = NULL, legendPosition = NULL, bucketSize = NULL) {
    structure(list(outlierPercentile = outlierPercentile, showItemDividers = showItemDividers, 
        series = series, legendPosition = legendPosition, bucketSize = bucketSize), 
        class = "gar_HistogramChartSpec")
}
...
#' @export
UpdateValuesResponse <- function(updatedColumns = NULL, spreadsheetId = NULL, updatedRange = NULL, 
    updatedCells = NULL, updatedRows = NULL, updatedData = NULL) {
    structure(list(updatedColumns = updatedColumns, spreadsheetId = spreadsheetId, 
        updatedRange = updatedRange, updatedCells = updatedCells, updatedRows = updatedRows, 
        updatedData = updatedData), class = "gar_UpdateValuesResponse")
}
...
#' @export
WaterfallChartSeries <- function(subtotalColumnsStyle = NULL, positiveColumnsStyle = NULL, 
    data = NULL, negativeColumnsStyle = NULL, hideTrailingSubtotal = NULL, customSubtotals = NULL) {
    structure(list(subtotalColumnsStyle = subtotalColumnsStyle, positiveColumnsStyle = positiveColumnsStyle, 
        data = data, negativeColumnsStyle = negativeColumnsStyle, hideTrailingSubtotal = hideTrailingSubtotal, 
        customSubtotals = customSubtotals), class = "gar_WaterfallChartSeries")
}
...
#' @export
BatchClearValuesByDataFilterResponse <- function(spreadsheetId = NULL, clearedRanges = NULL) {
...
#' @export
TreemapChartColorScale <- function(midValueColor = NULL, maxValueColor = NULL, minValueColor = NULL, 
    noDataColor = NULL) {
    structure(list(midValueColor = midValueColor, maxValueColor = maxValueColor, 
        minValueColor = minValueColor, noDataColor = noDataColor), class = "gar_TreemapChartColorScale")
}
...
#' @export
DeveloperMetadataLookup <- function(locationMatchingStrategy = NULL, metadataLocation = NULL, 
    locationType = NULL, metadataKey = NULL, visibility = NULL, metadataId = NULL, 
    metadataValue = NULL) {
    structure(list(locationMatchingStrategy = locationMatchingStrategy, metadataLocation = metadataLocation, 
        locationType = locationType, metadataKey = metadataKey, visibility = visibility, 
        metadataId = metadataId, metadataValue = metadataValue), class = "gar_DeveloperMetadataLookup")
}
...
#' @export
GetSpreadsheetByDataFilterRequest <- function(includeGridData = NULL, dataFilters = NULL) {
    structure(list(includeGridData = includeGridData, dataFilters = dataFilters), 
...
#' @export
FindReplaceResponse <- function(formulasChanged = NULL, valuesChanged = NULL, occurrencesChanged = NULL, 
    rowsChanged = NULL, sheetsChanged = NULL) {
    structure(list(formulasChanged = formulasChanged, valuesChanged = valuesChanged, 
        occurrencesChanged = occurrencesChanged, rowsChanged = rowsChanged, sheetsChanged = sheetsChanged), 
...
#' @export
UpdateValuesByDataFilterResponse <- function(updatedRange = NULL, updatedCells = NULL, 
    dataFilter = NULL, updatedRows = NULL, updatedData = NULL, updatedColumns = NULL) {
    structure(list(updatedRange = updatedRange, updatedCells = updatedCells, dataFilter = dataFilter, 
...
#' @export
UpdateConditionalFormatRuleResponse <- function(newIndex = NULL, oldIndex = NULL, 
    newRule = NULL, oldRule = NULL) {
    structure(list(newIndex = newIndex, oldIndex = oldIndex, newRule = newRule, oldRule = oldRule), 
...
#' @export
TreemapChartSpec <- function(labels = NULL, colorData = NULL, colorScale = NULL, 
    maxValue = NULL, hideTooltips = NULL, hintedLevels = NULL, levels = NULL, minValue = NULL, 
    sizeData = NULL, textFormat = NULL, parentLabels = NULL, headerColor = NULL) {
    structure(list(labels = labels, colorData = colorData, colorScale = colorScale, 
        maxValue = maxValue, hideTooltips = hideTooltips, hintedLevels = hintedLevels, 
        levels = levels, minValue = minValue, sizeData = sizeData, textFormat = textFormat, 
        parentLabels = parentLabels, headerColor = headerColor), class = "gar_TreemapChartSpec")
}
...
#' @export
Spreadsheet <- function(properties = NULL, spreadsheetId = NULL, namedRanges = NULL, 
    developerMetadata = NULL, sheets = NULL, spreadsheetUrl = NULL) {
    structure(list(properties = properties, spreadsheetId = spreadsheetId, namedRanges = namedRanges, 
        developerMetadata = developerMetadata, sheets = sheets, spreadsheetUrl = spreadsheetUrl), 
...
#' @export
HistogramRule <- function(end = NULL, interval = NULL, start = NULL) {
    structure(list(end = end, interval = interval, start = start), class = "gar_HistogramRule")
}
...
#' @export
DataFilter <- function(developerMetadataLookup = NULL, a1Range = NULL, gridRange = NULL) {
    structure(list(developerMetadataLookup = developerMetadataLookup, a1Range = a1Range, 
        gridRange = gridRange), class = "gar_DataFilter")
}
...
TextFormat <- function(fontFamily = NULL, strikethrough = NULL, italic = NULL, fontSize = NULL, 
    underline = NULL, foregroundColor = NULL, bold = NULL) {
    structure(list(fontFamily = fontFamily, strikethrough = strikethrough, italic = italic, 
        fontSize = fontSize, underline = underline, foregroundColor = foregroundColor, 
        bold = bold), class = "gar_TextFormat")
}
...
#' @export
SpreadsheetProperties <- function(autoRecalc = NULL, defaultFormat = NULL, title = NULL, 
    timeZone = NULL, locale = NULL, iterativeCalculationSettings = NULL) {
    structure(list(autoRecalc = autoRecalc, defaultFormat = defaultFormat, title = title, 
        timeZone = timeZone, locale = locale, iterativeCalculationSettings = iterativeCalculationSettings), 
...
#' @export
RepeatCellRequest <- function(cell = NULL, range = NULL, fields = NULL) {
    structure(list(cell = cell, range = range, fields = fields), class = "gar_RepeatCellRequest")
}
...
#' @export
ProtectedRange <- function(unprotectedRanges = NULL, namedRangeId = NULL, protectedRangeId = NULL, 
    warningOnly = NULL, requestingUserCanEdit = NULL, editors = NULL, range = NULL, 
    description = NULL) {
    structure(list(unprotectedRanges = unprotectedRanges, namedRangeId = namedRangeId, 
        protectedRangeId = protectedRangeId, warningOnly = warningOnly, requestingUserCanEdit = requestingUserCanEdit, 
        editors = editors, range = range, description = description), class = "gar_ProtectedRange")
}
